import type { ImageStyle, StyleProp, TextInput, TextInputProps, TextStyle, ViewStyle } from 'react-native';
export type GooglePlacesLanguage = 'af' | 'am' | 'ar' | 'az' | 'be' | 'bg' | 'bn' | 'bs' | 'ca' | 'cs' | 'da' | 'de' | 'el' | 'en-AU' | 'en-GB' | 'en' | 'es-419' | 'es' | 'et' | 'eu' | 'fa' | 'fi' | 'fil' | 'fr-CA' | 'fr' | 'gl' | 'gu' | 'hi' | 'hr' | 'hu' | 'hy' | 'id' | 'is' | 'it' | 'iw' | 'ja' | 'ka' | 'kk' | 'km' | 'kn' | 'ko' | 'ky' | 'lo' | 'lt' | 'lv' | 'mk' | 'ml' | 'mn' | 'mr' | 'ms' | 'my' | 'ne' | 'nl' | 'no' | 'pa' | 'pl' | 'pt-BR' | 'pt-PT' | 'pt' | 'ro' | 'ru' | 'si' | 'sk' | 'sl' | 'sq' | 'sr' | 'sv' | 'sw' | 'ta' | 'te' | 'th' | 'tr' | 'uk' | 'ur' | 'uz' | 'vi' | 'zh-CN' | 'zh-HK' | 'zh-TW' | 'zh' | 'zu';
...
export interface GooglePlacesStructuredFormatting {
    ...
    readonly secondary_text_matched_substrings: ReadonlyArray<Record<string, unknown>>;
}
...
export interface GooglePlacesAutocompleteProps {
    ...
    readonly GooglePlacesSearchQuery?: Partial<GooglePlacesQuery<GooglePlacesSearchType>>;
    ...
    readonly nearbyPlacesAPI?: 'GoogleReverseGeocoding' | 'GooglePlacesSearch' | 'None';
    readonly numberOfLines?: number;
    readonly onFail?: (error: GooglePlacesApiError) => void;
    readonly onNotFound?: () => void;
    readonly onPress?: (data: GooglePlaceData, detail: GooglePlaceDetail | null) => void;
    ...
    readonly renderRow?: (data: GooglePlaceData, index: number) => React.ReactNode;
...
export type GooglePlacesApiError = GooglePlacesNetworkError | GooglePlacesTimeoutError | GooglePlacesApiResponseError | GooglePlacesAbortError;
...
export type GooglePlacesAutocompleteResponse = GooglePlacesAutocompleteLegacyResponse | GooglePlacesAutocompleteNewResponse;
...
export type GooglePlacesDetailsResponse = GooglePlacesDetailsLegacyResponse | GooglePlacesDetailsNewResponse;
